...
class Bone_Tree:
    def __init__(self, bvh_file_path) -> None:
        ...
        self.joint_name = self.process_joint_name(self.joint_List)
        self.joint_offset = self.process_joint_offset(self.joint_List)
        self.joint_parent = self.process_joint_parent(self.joint_List)
