...
def part1_simple(viewer, target_pos):
    ...
    meta_data = MetaData(
        joint_name, joint_parent, joint_initial_position, "RootJoint", "lWrist_end"
    )
    joint_position = viewer.get_joint_positions()
    joint_orientation = viewer.get_joint_orientations()

    # print("joint_name:", meta_data.joint_name)
    # print("joint_parent: ", meta_data.joint_parent)
    # print("joint_initial_position: ", meta_data.joint_initial_position)
    # print("joint_root_joint: ", meta_data.root_joint)
    ...
    # print("path: ", path, "path_name: ",path_name, "path1: ", path1, "path2: ", path2)
...
def part1_hard(viewer, target_pos):
    ...
    joint_name, joint_parent, joint_initial_position = viewer.get_meta_data()
    meta_data = MetaData(
        joint_name, joint_parent, joint_initial_position, "lToeJoint_end", "lWrist_end"
    )
    joint_position = viewer.get_joint_positions()
    joint_orientation = viewer.get_joint_orientations()
...
def part1_animation(viewer, target_pos):
    ...
    class UpdateHandle:
        ...
        def update_func(self, viewer):
            ...
            self.joint_position, self.joint_orientation = part1_inverse_kinematics(
...
def bonus(viewer, left_target_pos, right_target_pos):
    ...
    class UpdateHandle:
        def __init__(
            self, left_marker, right_marker, joint_position, joint_orientation
        ):
        ...
        def update_func(self, viewer):
            ...
            self.joint_position, self.joint_orientation = bonus_inverse_kinematics(
                meta_data,
                self.joint_position,
